...
;; Absolutely not idea where to start... just a copy pate of this without
;; even trying to understand ... https://github.com/rjray/advent-2023-clojure/blob/master/src/advent_of_code/day24.clj

(def content (puzzle 24))
...
(defn- to-coords [lines]
  (mapv (comp (partial mapv vec) (partial partition 3) parse-out-longs)
        lines))
